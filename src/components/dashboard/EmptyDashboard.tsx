...
const EmptyDashboard = () => {
  ...
  return <div className="text-center py-16">
      <div className="mb-12 bg-white/80 backdrop-blur-sm rounded-lg p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
        <div className="bg-white/80 backdrop-blur-sm rounded-lg border border-white/30 p-6 text-center">
