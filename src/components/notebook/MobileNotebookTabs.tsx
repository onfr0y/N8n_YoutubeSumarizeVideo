...
const MobileNotebookTabs = ({
  ...
  return (
    <Tabs defaultValue="chat" className="flex-1 flex flex-col overflow-hidden">
      <TabsList className="grid w-full grid-cols-3 bg-white/5 backdrop-blur-xl p-1 h-12 rounded-none border-b border-white/20">
        <TabsTrigger 
          value="sources" 
          className="flex items-center space-x-2 text-sm text-white/80 data-[state=active]:bg-white/20 data-[state=active]:text-white data-[state=active]:shadow-sm"
        >
