...
const MobileNotebookTabs = ({
  ...
  return (
    <Tabs defaultValue="chat" className="flex-1 flex flex-col overflow-hidden">
      <TabsList className="grid w-full grid-cols-3 bg-white/80 backdrop-blur-sm p-1 h-12 rounded-none border-b border-white/20">
        <TabsTrigger 
          value="sources" 
          className="flex items-center space-x-2 text-sm data-[state=active]:bg-white/90 data-[state=active]:shadow-sm"
        >
